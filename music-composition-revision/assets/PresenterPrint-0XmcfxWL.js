import{d as _,u as d,a as p,c as m,b as h,r as u,e as a,f as t,t as s,g as l,F as f,h as v,n as g,i as x,o as n,j as y,k as b,l as k,m as N,_ as w}from"./index-BxLwVN70.js";import{N as P}from"./NoteDisplay-CcfofqVH.js";const V={class:"m-4"},L={class:"mb-10"},S={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},B={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},C=_({__name:"PresenterPrint",setup(F){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
